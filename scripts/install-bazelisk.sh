...
# firstmate-port delta vs serviceradar: always download. The ubuntu-latest
# runner image ships its own bazelisk, and blindly trusting a preinstalled
# binary of unknown version broke verification (SHA256 mismatch); GitHub
# releases are reachable and the pinned hash is independently verified.
